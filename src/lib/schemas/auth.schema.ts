...
export const LoginOutputSchema = z.nullable(
  z.object({
    ...
    roles: z.object({
      asistencia: z.enum(['Administrador', 'Instructor', 'Ayudantía', 'Bombero', 'Oficial', 'Ninguno']),
      semanas: z.enum(['Administrador', 'Encargado', 'Bombero', 'Oficial', 'Ninguno']),
      movilidad: z.enum(['Administrador', 'Operador', 'Bombero', 'Oficial', 'Ninguno']),
    }),
  })
);
