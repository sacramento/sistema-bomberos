...
import { addAspiranteWorkshop } from "@/services/aspirantes-workshops.service";
...
export default function AddAspiranteWorkshopDialog({ children, onWorkshopAdded }: { children: React.ReactNode; onWorkshopAdded: () => void; }) {
  const [open, setOpen] = useState(false);
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        await addAspiranteWorkshop(newWorkshopData, {});
