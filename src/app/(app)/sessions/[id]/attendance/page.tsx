...
export default function AttendancePage({ params }: { params: { id: string } }) {
    ...
    return (
        <>
            <PageHeader title={`Asistencia: ${session.title}`} description={`Sesión del ${session.date} a las ${session.startTime}hs.`}>
                        ...
                        <div className="md:col-span-4">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Marque el estado de cada bombero asignado a esta sesión.</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <Table>
                                        <TableHeader>
                        ...
                        <div className="md:col-span-3">
                             <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Resumen de la asistencia registrada para esta sesión.</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <Table>
                                        <TableHeader>
