        ...
        <div className="space-y-8">
            ...
            <Card className="shadow-md">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 pt-6">
                    ...
                    <div className="space-y-2"><Label className="text-xs font-bold">1. Categoría Principal</Label><MultiSelectFilter title="Categorías" options={CLOTHING_CATEGORIES.map(c => ({ value: c.id, label: c.label }))} selected={filterCategories} onSelectedChange={(v) => { setFilterCategories(v); setFilterSubCategories([]); setFilterItemTypes([]); }} /></div>
                    ...
                    <div className="space-y-2"><Label className="text-xs font-bold">3. Tipo de Prenda</Label><MultiSelectFilter title="Tipos" options={itemTypeOptions} selected={filterItemTypes} onSelectedChange={setFilterItemTypes} /></div>
