...
export default function QrScannerDialog({
  ...
  const elementId = "barcode-reader-clothing";
      ...
      const startScanner = async () => {
        try {
          ...
          await html5QrCode.start(
            ...
            () => {} // Silent failures for frame processing
          );
          ...
          toast({
            ...
            description: 'No se pudo acceder a la cámara. Verifique los permisos en su navegador.',
          });
        }
      };
    ...
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-0">
          ...
          <DialogDescription>Apunte la cámara al código QR o de barras de la prenda.</DialogDescription>
        </DialogHeader>
          ...
          {!hasCameraPermission && (
            <div className="absolute inset-0 flex items-center justify-center bg-black/80 z-10">
              <Alert variant="destructive" className="m-4">
                ...
                <AlertDescription>
                  Habilite los permisos de cámara para realizar el escaneo.
                </AlertDescription>
              </Alert>
            </div>
          )}
