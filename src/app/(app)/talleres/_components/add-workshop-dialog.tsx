...
import { addWorkshop } from "@/services/workshops.service";
...
export default function AddWorkshopDialog({ children, onWorkshopAdded }: { children: React.ReactNode; onWorkshopAdded: () => void; }) {
  const [open, setOpen] = useState(false);
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        toast({
            title: "¡Éxito!",
            description: `El nuevo taller ha sido creado con ${attendees.length} asistentes.`,
        });
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2 col-span-1 md:col-span-2">
              ...
              <Textarea id="description" placeholder="Describa brevemente el taller..." value={description} onChange={(e) => setDescription(e.target.value)} />
            </div>
            <div className="space-y-2">
    ...
    <Dialog open={open} onOpenChange={(isOpen) => {
        ...
        <DialogContent className="w-[95vw] max-w-xl rounded-md flex flex-col max-h-[90vh]">
             <DialogHeader>
                ...
                <DialogDescription>
                Paso {step} de {totalSteps} - Complete los detalles del nuevo taller de capacitación.
                </DialogDescription>
