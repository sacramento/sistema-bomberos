...
export default function AttendancePage() {
    ...
    const groupedAttendees = useMemo(() => {
        ...
        const c1Bombers = allParticipants.filter(a => a.rank === 'BOMBERO' && a.firehouse === 'Deposito C1').sort((a,b) => a.legajo.localeCompare(b.legajo));
        const c2Bombers = allParticipants.filter(a => a.rank === 'BOMBERO' && a.firehouse === 'Deposito C2').sort((a,b) => a.legajo.localeCompare(b.legajo));
        const c3Bombers = allParticipants.filter(a => a.rank === 'BOMBERO' && a.firehouse === 'Deposito C3').sort((a,b) => a.legajo.localeCompare(b.legajo));
