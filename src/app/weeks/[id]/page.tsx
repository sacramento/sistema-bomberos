...
import { Users, Truck, User, PlusCircle } from "lucide-react";
...
export default function WeekDetailPage() {
    ...
    const canManageTasks = user?.role === 'Administrador' || user?.id === week?.leadId;
    ...
    const handleTaskAdded = () => {
        // Here we would refetch the tasks for the week
            ...
            <div className="grid gap-8 md:grid-cols-3">
                <div className="md:col-span-2 space-y-8">
                    ...
                    {/* Tasks Card */}
                     <Card>
                        <CardHeader>
                            <CardTitle className="font-headline">Tareas de la Semana</CardTitle>
                        </CardHeader>
                        <CardContent>
