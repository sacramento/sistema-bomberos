    ...
    if (isMobile) {
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            side={side}
            className="w-[var(--sidebar-width)] bg-sidebar p-0 text-sidebar-foreground data-[side=left]:border-r-sidebar-border data-[side=right]:border-l-sidebar-border [&>button]:right-2 [&>button]:top-2"
