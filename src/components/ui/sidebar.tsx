...
>(
  (
    ...
    // Handle the case where isMobile is still undefined during server-side rendering
    ...
    return (
      <div
        ref={ref}
        className={cn("group hidden md:flex md:flex-col text-sidebar-foreground border-r transition-all duration-300 ease-in-out", 
